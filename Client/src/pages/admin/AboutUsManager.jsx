...
const DUMMY_CONTENT = [
  {
    id: 1,
    title: "Giới thiệu",
    content: "Nội dung giới thiệu về doanh nghiệp...",
    isHighlight: true,
  },
  {
    id: 2,
    title: "Tầm nhìn & Sứ mệnh",
    content: "Chúng tôi hướng đến...",
    isHighlight: false,
  },
];

export default function AboutUsManager() {
  const [sections, setSections] = useState(DUMMY_CONTENT);
  ...
  const handleSave = (section) => {
    if (section.id) {
      ...
      setSections([...sections, { ...section, id: Date.now() }]);
    }
            ...
            <div className="relative bg-white w-full max-w-2xl rounded-xl shadow-2xl">
              <div className="flex items-center justify-between p-6 border-b">
                <h3 className="text-xl font-semibold text-gray-900">
                  {editingSection.id ? "Chỉnh sửa mục" : "Thêm mục mới"}
                </h3>
                <button
                  onClick={() => setEditingSection(null)}
              ...
              <form
                onSubmit={(e) => {
                  ...
                  handleSave({
                    ...
                    isHighlight: e.target.isHighlight.checked,
                  });
                }}
              ...
              >
                ...
                <div className="flex items-center">
                  <input
                    name="isHighlight"
                    type="checkbox"
                    defaultChecked={editingSection.isHighlight}
                    className="h-4 w-4 text-blue-600 rounded focus:ring-blue-500"
                  />
                  <label className="ml-2 text-sm text-gray-700">
                    Đánh dấu là mục nổi bật
                  </label>
                </div>
